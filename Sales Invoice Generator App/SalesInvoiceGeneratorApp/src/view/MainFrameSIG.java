...
import controller.InvoiceListenerSIG;
 ...
 * @author dell
 */
public class MainFrameSIG extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLoadFile.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L, java.awt.event.InputEvent.CTRL_MASK));
        btnLoadFile.setText("Load File");
        fileMenu.add(btnLoadFile);

        btnSaveFile.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_MASK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainFrameSIG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MainFrameSIG mainFrame = new MainFrameSIG();
    ...
    private InvoiceListenerSIG myListner = new InvoiceListenerSIG(this);
    public static SimpleDateFormat dFormat = new SimpleDateFormat("dd-MM-yyyy");
    private ArrayList<InvoiceModelSIG> invoices ;
    private InvoiceTableModelSIG invoiceTableModel;

    public ArrayList<InvoiceModelSIG> getInvoices() {
        if(invoices==null){
    ...
    public void setInvoices(ArrayList<InvoiceModelSIG> invoices) {
        this.invoices = invoices;
    }

    public InvoiceTableModelSIG getInvoiceTableModel() {
        return invoiceTableModel;
    }

    public void setInvoiceTableModel(InvoiceTableModelSIG invoiceTableModel) {
        this.invoiceTableModel = invoiceTableModel;
    }

    public InvoiceListenerSIG getMyListner() {
        return myListner;
    }
